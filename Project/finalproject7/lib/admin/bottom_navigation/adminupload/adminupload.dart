...
class AdminUploadPage extends State<AdminUpload> {
  ...
  final String uploadUrl = 'https://prakrutitech.buzz/Project_API/upload_category_main_image.php';
  ...
  Future<List> getCategoryName() async {
    var data = await http.get(Uri.parse("https://prakrutitech.buzz/Project_API/category_view.php"));
    return json.decode(data.body);
  }

  XFile? _categoryImageFile;
  //late PickedFile _categoryImageFile;
  final String categoryUploadUrl = 'https://prakrutitech.buzz/Project_API/upload_category_sub_image_insert.php';
