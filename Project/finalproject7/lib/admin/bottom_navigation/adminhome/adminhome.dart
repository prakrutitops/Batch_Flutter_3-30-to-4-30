...
class AdminHomePage extends State<AdminHome> {
  Future<List> viewCategoryData() async{
    final responce = await http.get(Uri.parse("https://prakrutitech.buzz/Project_API/category_view.php"));
...
class _Items extends State<Items>{
  ...
  {
    var url = "https://prakrutitech.buzz/Project_API/category_delete.php";
